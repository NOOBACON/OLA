...
function setup(){
  ...
  mainCyclist.setCollider("rectangle",0,0,mainCyclist.width-500,mainCyclist.height-500);
...
function draw() {
  ...
  if(gameState===PLAY){
   ...
   mainCyclist.velocityY=(mouseY-mainCyclist.y)/6; 
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("PRESS UP ARROW TO RESTART", canvas.width/2-105, canvas.height/2+50)
